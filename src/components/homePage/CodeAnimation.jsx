...
const codeLines = [
  ...
  "<p>Let's learn coding</p>",
  "</body>",
  "</html>",
];

const CodeAnimation = ({ cardNumber }) => {
  ...
  return (
    <Tilt
      ...
      className="tilt-wrapper rounded-lg"
    >
      <motion.div
        initial="hidden"
        animate="visible"
        variants={containerVariants}
        className="bg-gray-900 cursor-pointer text-green-400 p-6 sm:p-8 rounded-xl font-mono text-base text-[14px] screen2:text-[15px] w-[365px] screen2:w-[500px] h-[430px] screen2:h-[430px] overflow-hidden shadow-xl border border-green-900/50 relative code-terminal"
      >
        {/* Terminal header */}
...
export default React.memo(CodeAnimation);
